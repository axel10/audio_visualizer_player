...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 1627267844;
...
fn wire__crate__api__simple__extract_waveform_streaming_impl(
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "extract_waveform_streaming",
            port: None,
        ...
        move || {
            ...
            deserializer.end();
            transform_result_sse::<_, String>((move || {
                let output_ok = crate::api::simple::extract_waveform_streaming(
                    api_expected_chunks,
                    api_sample_stride,
                    api_sink,
                )?;
...
impl SseDecode
    for StreamSink<crate::api::simple::WaveformChunk, flutter_rust_bridge::for_generated::SseCodec>
{
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        let mut inner = <String>::sse_decode(deserializer);
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    // Codec=Pde (Serialization + dispatch), see doc to use other codecs
    match func_id {
        3 => wire__crate__api__simple__extract_waveform_streaming_impl(ptr, rust_vec_len, data_len),
...
impl flutter_rust_bridge::IntoDart for crate::api::simple::WaveformChunk {
...
impl flutter_rust_bridge::for_generated::IntoDartExceptPrimitive
    for crate::api::simple::WaveformChunk
{
}
impl flutter_rust_bridge::IntoIntoDart<crate::api::simple::WaveformChunk>
    for crate::api::simple::WaveformChunk
{
    fn into_into_dart(self) -> crate::api::simple::WaveformChunk {
        self
    }
}
...
impl SseEncode for crate::api::simple::WaveformChunk {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
